//  2018-04-18 by ELEMYO (https://github.com/ELEMYO/Arduino)
	...
	class ELEMYO {
		...
		private:
			...
			BANDSTOP BS[5];		// array of BandStop filters with different notch frequency

			int NumLP = 0;		// number of LowPass filters with different cutoff frequency
			LOWPASS LP[2];		// array of LowPass filters with different cutoff frequency

			int NumHP  = 0;		// number of HIGHPASS filters with different cutoff frequency
			HIGHPASS HP[2];		// array of HIGHPASS filters with different cutoff frequency

			int NumBP = 0;		// number of BANDPASS filters with different lower or upper cutoff frequencys
			BANDPASS BP[2];		// array of BANDPASS filters with different lower or upper cutoff frequencys
